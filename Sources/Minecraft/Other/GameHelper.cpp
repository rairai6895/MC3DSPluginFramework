...
namespace MC3DSPluginFramework
{
    namespace GameHelper
    {
        ...
        /*
        bool Eat(int speed) {
        if (const ItemInstance *inv = Inventory::Get(Inventory::HeldSlot()))
            return reinterpret_cast<bool (*)(Entity *, const ItemInstance *, int)>(0x600798)(Player::GetInstance(), inv, std::clamp<int>(0x20 - speed, 1, 0x20));
        return false;
        }

        bool UseBow(bool fullCharge) {
        if (const ItemInstance *inv = Inventory::Get(Inventory::HeldSlot()))
            if (inv->mItem->Name() == "bow")
                return reinterpret_cast<bool (*)(Entity *, const ItemInstance *, int)>(0x600798)(Player::GetInstance(), inv, fullCharge ? 0x1192C : 0x11940);
        return false;
        }
        */
        ...
        void ShotArrow(u32 charge)
        {
            ...
            if (const Entity *player = Player::GetInstance())
                reinterpret_cast<void (*)(u32, u32, const Entity *, int)>(0x72AA94)(*(u32 *)0xB0D304, player->Offset(0x18B4), player, 0x11940 - charge);
        }

        bool IsMultiPlayer(void)
        {
            if (const Entity *player = Player::GetInstance())
                return reinterpret_cast<bool (*)(Level *)>(0x720908)(player->GetLevel());
            return false;
        }
        ...
        */
        ...
        {
            reinterpret_cast<void (*)(Item *, ItemInstance &, Entity *)>(0x735B50)(item.mItem, item, entity);
        }

        bool IsWearableItem(const ItemInstance &item)
        {
            return reinterpret_cast<bool (*)(const ItemInstance &)>(0x6B15A0)(item);
        }

        bool IsEquiped(Entity *entity, const ItemInstance &item)
        {
            return reinterpret_cast<bool (*)(u32, const ItemInstance &)>(0x6B2954)(entity->Offset(0xF70), item);
        }
        ...
        */
        ...
        gstd::vector<Entity *> *GetEntityList(void)
        {
            ...
            */
            ...
            if (EntityRenderDispatcher *instance = EntityRenderDispatcher::getInstance()) {
                u32 *ptr = (u32 *)(instance->getClientInstance()->getMinecraftGame()->offset(0x48));
        ...
        {
            if (EntityRenderDispatcher *instance = EntityRenderDispatcher::getInstance()) {
                if (gstd::vector<u32> *vec = *(gstd::vector<u32> **)(instance->getClientInstance()->getMinecraftGame()->offset(0x6C)))
                    if (u32 instance = *(u32 *)((*vec)[4] + 0x1F8))
                        return reinterpret_cast<bool (*)(u32, gstd::string)>(0x33E5E0)(instance, str);
            }
            return false;
        }
        ...
        */
        ...
        bool Format(gstd::string &res, const gstd::string &str1, const gstd::string &str2)
        {
            return reinterpret_cast<bool (*)(gstd::string &, const gstd::string &, const gstd::string &)>(0x121538)(res, str1, str2);
        }
