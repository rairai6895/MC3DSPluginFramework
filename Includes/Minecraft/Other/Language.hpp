...
namespace MC3DSPluginFramework
{
    ...
    public:
        ...
        gstd::string getLocale(void)
        {
            return mLocale;
        }

        bool get(gstd::string key, gstd::string *out, const gstd::vector<const char *> *params)
        {
            return reinterpret_cast<bool (*)(Language *, gstd::string, gstd::string *, const gstd::vector<const char *> *)>(0x12A8A0)(this, key, out, params);
        }
    ...
    public:
        ...
        // params = フォーマット引数
        // FUN_0x11D954
        static gstd::string get(gstd::string key, const gstd::vector<const char *> *params = nullptr)
        {
            gstd::string out;
