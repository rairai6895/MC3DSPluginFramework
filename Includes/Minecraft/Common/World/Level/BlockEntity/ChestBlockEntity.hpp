...
namespace MC3DSPluginFramework
{
    ...
    public:
        ...
        bool canPairWith(const ChestBlockEntity *other, const Vec3_Int &pos)
        {
            return reinterpret_cast<bool (*)(const ChestBlockEntity *, const ChestBlockEntity *, const Vec3_Int &)>(0x30BC40)(this, other, pos);
        }
