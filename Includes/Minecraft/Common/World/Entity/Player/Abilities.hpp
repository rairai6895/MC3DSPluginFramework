...
namespace MC3DSPluginFramework
{
    ...
    public:
        ...
        {
            return reinterpret_cast<Ability *(*)(Abilities *, gstd::string)>(0x735384)(this, ability);
        }

        bool getBool(gstd::string ability) const
        {
            return reinterpret_cast<bool (*)(const Abilities *, gstd::string)>(0x7356A4)(this, ability);
        }

        void setBool(gstd::string ability, bool flag)
        {
            reinterpret_cast<void (*)(Abilities *, gstd::string, bool)>(0x665B14)(this, ability, flag);
        }

        bool isFlying(void) const
        {
            // flying || noclip
            return reinterpret_cast<bool (*)(const Abilities *)>(0x73576C)(this);
        }
