...
namespace MC3DSPluginFramework
{
    ...
    public:
            ...
            mUnk1(unknown1), mUnk2(unknown2), mName(name)
        {
            ...
            auto &mAttributesMap = reinterpret_cast<gstd::map<gstd::string, Attribute *> &(*)()>(0x3AD008)();
            reinterpret_cast<void (*)(gstd::map<gstd::string, Attribute *> &, gstd::string, Attribute *)>(0x3ACB6C)(mAttributesMap, name, this);
        }
